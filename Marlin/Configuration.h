...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kd_LIST { 101.66, 101.66 }
  #else
    #define DEFAULT_Kp  28.53
    #define DEFAULT_Ki   2.00
    #define DEFAULT_Kd 101.66
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 234.90
  #define DEFAULT_bedKi 46.25
  #define DEFAULT_bedKd 298.27
...
#define X_BED_SIZE 220 // ncrmro
#define Y_BED_SIZE 240 // ncrmro
